...
ユーザーは Agent に「メールに返答があったので確認してコンテキストを更新して」
のように依頼する。Agent は元情報を Source として保存し、Task に必要な情報を
Context に整理する。

(1) Source を取り込む

(2) Agent が Source を ingest する

(3) Source から Task Context を更新する

(4) ユーザーが Agent との対話で不足情報を追加する
...
- Agent が Source を ingest し、Context が更新される
